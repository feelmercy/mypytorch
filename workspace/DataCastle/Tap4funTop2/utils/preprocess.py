...
def feature_expand():
	train=pd.read_csv('F:\\study\\ml\\DataSet\\Tap4fun\\tap_fun_train.csv')
	test=pd.read_csv('F:\\study\\ml\\DataSet\\Tap4fun\\tap_fun_test.csv')
	...
	train_processed.to_csv('F:\\study\ml\\DataSet\\p4fun\\top2\\train_expanded.csv', index=False)
	test_processed.to_csv('F:\\study\\ml\\DataSet\\Tap4fun\\top2\\est_expanded.csv', index=False)
